        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        <label for="title">{{trans('my_parant.National_ID_Mother')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('my_parant.Passport_ID_Mother')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('my_parant.Phone_Mother')}}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">{{trans('my_parant.Nationality_Father_id')}}</label>
                        <select class="custom-select my-1 mr-sm-2" wire:model="Nationally_Mother_id">
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('my_parant.Address_Mother')}}</label>
